...
function afisareStiri()
{
	...
	else { echo ' NU EXISTA STIRI POSTATE ' ; }
}
						 ...
						 echo '<div id="comentariu">
								 ...
								 .'<div id="utilizator_comentariu"> comentariu postat de : <strong>'.$comentariu['username'].'</strong></div><br/>			
								   <form name="val" id="val" method="POST" action="">';
			                            ...
			                            $validare='validare'.$i;
			                            if(isset($_POST[$validareButon])){ //daca se solicita schimbarea statusului comentariului
...
function headerCode()
{
	...
	if($query) { $user_logat = mysql_fetch_array($query); }
	echo '<strong>'.$user_logat['username'].'</strong> | <a href="index.php">HOME</a> | <a href="logout.php">Log Out</a>';
	}
	else {echo '<a href="login.php">Log In</a> | <a href="inregistrare.php">Inregistrare</a> | <a href="index.php">HOME</a> ';}
}
